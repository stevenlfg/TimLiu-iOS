...
* [DJRefresh](https://github.com/ydj/DJRefresh)-可高度自定义刷新显示的效果
 ...
 * [WMPageController](https://github.com/wangmchn/WMPageController)-可自定义各种样式
 
 * [WHC_-ContainerView](https://github.com/netyouli/WHC_-ContainerView)-高仿qq未读消息拖拽和网易新闻viewpager特效集成
 ...
 * [iToast_ios](https://github.com/Tim9Liu9/iToast-iOS)-iOS实现类似安卓Toast效果
 * [Toast](https://github.com/scalessec/Toast)-可高度自定义的Toast
